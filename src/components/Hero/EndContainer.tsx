function EndContainer() {
  return (
    <div className="relative overflow-hidden py-12! px-24! bg-[rgb(22,22,22)] text-amber-50 flex items-center justify-between group cursor-pointer border-t-[0.5px] border-b-[0.5px] border-border/40">
